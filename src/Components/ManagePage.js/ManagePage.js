...
const ManagePage = () => {
  ...
  useEffect(() => {
    axios
      .get("https://bengliyan-server-lizafaria.vercel.app/all")
      .then((Response) => {
  ...
  return (
    <div>
      <div className="flex justify-center mt-5">
        {" "}
        <button
          onClick={additembtnHandle}
          className="rounded w-6/12 max-w-[500px] min-w-[100px]  py-2 font-semibold text-gray-100 bg-green-400"
        >
          Add item
        </button>
      </div>
