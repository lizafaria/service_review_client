    ...
    <div className=" flex justify-center">
      <div className="p-5  rounded shadow-lg bg-gray-50 max-w-[400px] h-[700px ">
        ...
        <div className="space-y-2 mt-3">
          <small className="text-gray-50 px-5 py-1 bg-gray-300 rounded-md">
            {category}
          </small>
          <h1 className="text-xl font-semibold text-gray-900">{title}</h1>
          <p className="text-gray-600">
            supplier name :<span className="text-gray-800">{supplierName}</span>
          </p>
          ...
          <div className="flex justify-end">
            {" "}
            <button
              onClick={() => updatebtnHandle(_id)}
              className="px-7 py-1.5 text-xl bg-green-600 text-gray-200 font-semibold rounded-3xl"
            >
              Details
            </button>
          </div>
