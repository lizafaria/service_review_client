...
const CarosolCard = ({ image, styles, catagory, heading }) => {
  return (
      ...
      <div className="flex justify-center items-center ml-5 my-5 order-2 md:order-1 ">
        <div className="space-y-5 w-10/12">
          ...
          <p className="text-base text-gray-700 md:text-xl">
            You can Find Any Books Her. Even You can Publish Your Book Also
          </p>
          <button className="bg-basic text-white px-5 py-1 text-xl rounded">
            read now
          </button>
        </div>
      </div>
