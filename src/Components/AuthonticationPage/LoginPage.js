    ...
    <div className="container mx-auto">
      <div className="login-section flex justify-center items-center pt-5 mx-auto relative">
        <div className=" w-11/12  h-[530px] bg-green-200 lg:w-3/12">
          <h1 className="text-center text-3xl mt-11 mb-9 text-gray-700 font-semibold">
            Welcome back
          </h1>
          <p className=" ml-9 font-semibold text-md text-gray-800">
          ...
          >
            <div className="w-10/12">
              <label className="text-base pt-2 text-gray-700" htmlFor="email">
                Email address:
              </label>

              <input
                className="block  w-full h-9 rounded bg-gray-100"
                type="email"
                name="email"
                id="email"
                required
              />
              <label
                className="text-base pt-2 text-gray-700"
                htmlFor="password"
              >
                Password :
              </label>
              ...
              <input
                className=" mt-5 w-full bg-green-400 py-1 text-white text-2xl rounded"
                type="submit"
                value="Login"
              />
              <div className="flex justify-end mt-2 text-gray-700">
                <p>Forget password?</p>
              </div>
            </div>
          </form>
          ...
          <div className="w-10/12 mx-auto mt-2">
            <p>
              ...
              <span
                className="text-blue-400 pl-0.5 underline cursor-pointer"
